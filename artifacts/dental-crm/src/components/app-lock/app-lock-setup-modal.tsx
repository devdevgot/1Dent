...
export function AppLockSetupModal({
  ...
  return (
    <AppDialog open={open} onOpenChange={(next) => { if (!next) onClose(); }} title={t("appLock.setupTitle")} size="sm">
      <div className="flex flex-col items-center px-2 pb-2">
        ...
        <p className="mb-1 text-center text-base font-bold text-[#0f172a]">
          {step === "enter" ? t("appLock.setupEnter") : t("appLock.setupConfirm")}
        </p>
        ...
        <div className="grid grid-cols-3 gap-2.5">
          ...
          <PinKey onClick={back} muted disabled={loading} aria-label={t("appLock.delete")}>
