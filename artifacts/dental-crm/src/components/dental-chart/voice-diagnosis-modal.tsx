        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--ds-border)]/50 shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-1.5 rounded-lg hover:bg-[var(--surface-2)] text-[var(--text-secondary)] transition-colors disabled:opacity-40"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
                              ...
                              <tr key={entry.fdi} className="bg-[var(--ds-surface)] hover:bg-[var(--bg)]/60">
                                ...
                                <td className="px-3 py-2.5 align-top max-w-0 min-w-0">
                                  {suggestions.length > 0 ? (
                                    ...
                                    <p className="text-[11px] text-[var(--text-secondary)] py-1.5">
