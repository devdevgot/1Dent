        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <Link
                href="/register"
                className="inline-flex items-center gap-2 bg-[#1f75fe] hover:bg-[#1a65e8] text-white font-manrope font-semibold px-8 py-4 rounded-full transition-all hover:scale-105 mb-8"
              >
