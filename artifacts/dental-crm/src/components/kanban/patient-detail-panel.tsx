                    ...
                    {!dentalLoading && hasDiagnosis && !isDiagnosisMode && (
                      <div className="space-y-3">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <div className="flex items-center shrink-0 rounded-lg border border-primary/30 overflow-hidden">
                            <button
                              onClick={() => setIsDiagnosisMode(true)}
                              className="flex items-center gap-1.5 text-[11px] font-medium text-primary hover:bg-primary/10 px-2.5 py-1 transition-colors"
                            >
                            ...
                            <button
                              onClick={() => setShowVoiceModal(true)}
                              className="flex items-center text-[11px] font-medium text-primary hover:bg-primary/10 px-2 py-1 transition-colors"
                              title="Голосовая диагностика"
                            >
