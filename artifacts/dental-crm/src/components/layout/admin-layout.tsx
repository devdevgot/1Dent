  ...
  return (
    <div className="flex h-[100dvh] bg-[#faf8f4] overflow-hidden font-manrope">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Top bar */}
        <header className="flex-none h-14 bg-white border-b border-[#e8e3d9] flex items-center gap-3 px-4 z-10">
          {/* Mobile burger — only <768px */}
          {isMobile && (
            <button
              className="p-1.5 rounded-xl text-[#64748b] hover:bg-[#f1ede4] hover:text-[#0f172a] transition-colors"
