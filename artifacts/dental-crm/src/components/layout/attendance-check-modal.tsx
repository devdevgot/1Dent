  ...
  return (
    ...
    >
      ...
      <div className="px-5 py-5 space-y-4">
        <p className="text-sm font-semibold text-[#0f172a] text-center leading-relaxed">
        ...
        <div className="rounded-xl p-3.5 space-y-2.5 border border-[#e8e3d9] bg-[#faf8f4]">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs font-semibold text-[#64748b] w-20">Пациент:</span>
            <span className="text-xs font-bold text-[#0f172a] truncate">{patientName}</span>
          </div>

          <div className="flex items-center gap-2.5">
            <Stethoscope className="w-4 h-4 text-[#64748b] shrink-0" />
            <span className="text-xs font-semibold text-[#64748b] w-20">Процедура:</span>
            <span className="text-xs font-bold text-[#0f172a] truncate">{currentProc.name}</span>
          </div>

          <div className="flex items-center gap-2.5">
            <Clock className="w-4 h-4 text-[#64748b] shrink-0" />
            <span className="text-xs font-semibold text-[#64748b] w-20">Врач:</span>
