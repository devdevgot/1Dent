...
const PAGE_ITEMS: {
  ...
  { label: "Канбан",     href: "/kanban",          roles: ["owner","admin"],                                  Icon: KanbanSquare,    iconBg: "bg-violet-100", iconColor: "text-violet-600" },
  { label: "Пациенты",   href: "/patients",        roles: ["owner","admin","doctor"],                         Icon: Users,           iconBg: "bg-sky-100",    iconColor: "text-sky-600" },
  { label: "Процедуры",  href: "/procedures",      roles: ["owner","admin","accountant"],                     Icon: Stethoscope,     iconBg: "bg-green-100",  iconColor: "text-green-600" },
  ...
  { label: "Сотрудники", href: "/users",           roles: ["owner","admin"],                                  Icon: UserCog,         iconBg: "bg-slate-100",  iconColor: "text-slate-600" },
  { label: "Чат-бот",   href: "/chatbot",          roles: ["owner","admin"],                                  Icon: Bot,             iconBg: "bg-purple-100", iconColor: "text-purple-600" },
];
