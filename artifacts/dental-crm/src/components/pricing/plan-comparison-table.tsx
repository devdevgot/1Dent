      ...
      <div className="min-w-[320px] border border-[#e8e3d9] rounded-xl overflow-hidden bg-white">
        ...
        <div className={GRID_COLS}>
          <div className="px-3 py-2.5 flex items-end">
            <span className="text-micro font-semibold uppercase tracking-wider text-[#94a3b8]">
              Параметр
            </span>
          </div>
          {PLAN_IDS.map((planId) => (
        ...
        <p className="text-micro text-[#94a3b8] text-center py-2 px-3 border-t border-[#e8e3d9]/80 bg-[#faf8f4]/50 leading-relaxed">
