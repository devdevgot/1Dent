  ...
  return (
    <div className={cn("flex items-center gap-3 rounded-xl border px-3.5 py-2.5", config.bg)}>
      ...
      <div className="min-w-0 flex-1">
        <p className="text-xs font-semibold uppercase tracking-wide opacity-80">{config.label}</p>
        <p className="text-xs font-semibold text-[#0f172a] truncate">{config.title}</p>
      </div>
      {config.detail ? (
        <p className="text-xs font-medium shrink-0">{config.detail}</p>
      ) : null}
    </div>
  );
}
  ...
  return (
    <PageShell className="pb-10" animate={false}>
      ...
      <div className="px-4 pt-4 space-y-4 max-w-lg mx-auto">
        ...
        <p className="text-center text-xs text-[#94a3b8] leading-relaxed pb-2 px-1">
            ...
            {submitted ? (
              <div className="p-8 text-center">
                ...
                <button
                  type="button"
                  onClick={closeRequestModal}
                  className="px-6 py-2.5 bg-[#1f75fe] hover:bg-[#1a65e8] text-white rounded-full text-sm font-semibold transition-colors"
                >
                  Закрыть
                </button>
              </div>
              ...
              <div className="p-5 space-y-3">
                ...
                <button
                  ...
                  className="w-full py-3 bg-[#1f75fe] hover:bg-[#1a65e8] text-white rounded-full text-sm font-semibold transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                >
