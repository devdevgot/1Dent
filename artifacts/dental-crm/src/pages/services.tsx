...
export default function ServicesPage() {
  ...
  return (
    <div className="h-full flex flex-col bg-[#f2f2f7] overflow-hidden">
      ...
      {/* ── Category tabs ───────────────────────────── */}
      <div className="bg-white border-b border-gray-100 overflow-x-auto shrink-0 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
        <div className="max-w-3xl w-full mx-auto p-4 pb-12 space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="overflow-x-auto [scrollbar-width:thin] [scrollbar-color:#e5e7eb_transparent]">
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            ...
                            colClass,
                            isEditing ? "bg-primary/[0.03]" : "hover:bg-gray-50/60",
                          )}
                        >
                          {/* Code */}
                          <span className="text-xs text-gray-400 font-mono truncate">{t.code ?? "—"}</span>
