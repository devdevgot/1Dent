      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative overflow-y-auto">
        <div className="absolute top-8 left-8">
          <Link href="/login" className="text-sm font-semibold text-muted-foreground hover:text-primary transition-colors flex items-center">
            <ArrowRight className="w-4 h-4 mr-2 rotate-180" /> Back to login
          </Link>
        </div>
        ...
        >
          <div className="mb-10">
            <h2 className="text-3xl font-display font-bold text-foreground mb-2">Create your clinic</h2>
            <p className="text-muted-foreground">Set up your secure, multi-tenant workspace.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  {...register("email")}
                  type="email"
                  placeholder="admin@elitedental.com"
                  className={`
                    w-full pl-11 pr-4 py-3 rounded-xl bg-slate-50 border-2 outline-none transition-all
            ...
            >
              {registerMutation.isPending ? "Creating workspace..." : "Create Clinic Workspace"}
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-slate-900 items-center justify-center">
        ...
        <div className="relative z-10 p-12 max-w-lg text-white">
          ...
          <ul className="space-y-4 mt-8">
            {["Complete data isolation per clinic", "Granular role-based access control", "End-to-end activity auditing", "Automated inventory economy"].map((feature, i) => (
