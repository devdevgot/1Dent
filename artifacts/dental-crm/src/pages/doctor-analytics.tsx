...
export default function DoctorAnalyticsPage() {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden bg-background">
      {/* ── Header ─────────────────────────────────────────────────────────── */}
      <div className="shrink-0 border-b border-gray-100 bg-white px-4 pt-5 pb-4 flex items-center gap-3">
        <button
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-[17px] font-semibold text-gray-900">{t("doctorAnalytics.title")}</h1>
          </div>
          <p className="text-xs text-muted-foreground mt-0.5">{t("doctorAnalytics.subtitle")}</p>
        </div>
