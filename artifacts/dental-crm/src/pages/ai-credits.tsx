  ...
  return (
    <PageShell className="pb-8">
      <PageHeader
        ...
        right={
          <button
            ...
            disabled={isFetching}
            className="w-9 h-9 flex items-center justify-center rounded-xl hover:bg-[#f1ede4] text-[#64748b] transition-colors disabled:opacity-50"
      ...
      <div className="px-4 pt-4 space-y-4 max-w-2xl mx-auto">
        ...
        {isError && (
          <div className="bg-[var(--danger-light)] border border-[var(--danger-light)] rounded-2xl p-4 text-sm text-[#dc2626] space-y-2">
        ...
        {!isLoading && !isError && !summary && (
          <div className="bg-[var(--warning-light)] border border-[var(--warning-light)] rounded-2xl p-4 text-sm text-[#d97706]">
        ...
        {isOwner && (
          <Link
            href="/pricing"
            className="flex items-center justify-center gap-2 w-full py-3.5 bg-[var(--ds-primary)] text-white rounded-full text-sm font-semibold shadow-md hover:bg-[#1a65e8] hover:scale-105 transition-all"
          >
