...
export const PLANS: PlanConfig[] = [
  {
    ...
    highlights: [
      ...
      "До 10 сотрудников",
      "1 000 AI-кредитов в месяц",
      "300 диалогов чат-бота в месяц",
    ],
  ...
  },
  {
    ...
    highlights: [
      "Всё из тарифа START",
      "До 30 сотрудников · в 5× больше AI и чат-бот",
  ...
  },
  {
    ...
    highlights: [
      "Всё из тарифа PRO",
      "Несколько филиалов · единая база пациентов",
      "Безлимит сотрудников и шаблонов",
