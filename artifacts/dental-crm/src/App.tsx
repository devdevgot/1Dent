...
const StaffAnalyticsPage = lazyPage(() => import("@/pages/staff-analytics"), <DoctorAnalyticsPageSkeleton />);
...
function Router() {
  ...
  return (
    ...
    <Switch>
      ...
      <Route path="/users/:doctorId/analytics">
        <ProtectedRoute component={StaffAnalyticsPage} allowedRoles={['owner', 'admin']} />
      </Route>
