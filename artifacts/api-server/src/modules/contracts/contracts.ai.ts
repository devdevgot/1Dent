...
Для каждого найденного поля верни JSON-массив объектов:
{
  "placeholder": "точная подстрока из текста или описание места (например '__ФИО__' или '__________')",
...
Отвечай ТОЛЬКО JSON-массивом без лишнего текста. Если полей нет — верни [].`;
