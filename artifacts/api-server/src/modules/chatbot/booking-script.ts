...
export function buildDefaultBookingMindMap(): ScriptMindMapData {
  const nodes = [
    ...
    node(
      ...
      "Выясни причину: цена / страх процедуры / недостаток информации. Отработай: бесплатная консультация, индивидуальный план лечения, рассрочка 0-0-24. Предложи бесплатный осмотр.",
      "handle_objections",
      { x: -320, y: 960 },
    ),
    node(
