...
export function buildAgentOrchestratorPrompt(opts: BuildAgentPromptOpts): string {
  ...
  return [
    ...
    "2. Кратко: 1-2 предложения. Импровизируй, но следуй инструкции текущего узла.",
    "3. Филиалы: если несколько — покажи ВСЕ нумерованным списком в reply.",
    "4. Не выдумывай адреса, цены, врачей — только FACTS.",
    "5. mindMapNodeId — выбери из «Доступные переходы» когда пациент перешёл на следующий этап.",
    "",
    "=== OUTPUT ===",
