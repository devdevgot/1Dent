...
import dentalRouter, { diagnosisRouter } from "../modules/dental/dental.controller";
...
import customerCareRouter from "../modules/customer-care-chatbot/customer-care-chatbot.controller";
...
router.use("/customer-care", customerCareRouter);
